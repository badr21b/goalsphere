    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-6 flex">
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 rounded-xl overflow-hidden border border-purple-700/30 flex flex-col w-full"
        >
          {/* Hero Image */}
      ...
      <div className="lg:col-span-3 flex">
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 rounded-xl border border-purple-700/20 p-4 flex flex-col w-full"
        >
      ...
      <div className="lg:col-span-3 flex">
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-900/20 to-indigo-900/20 rounded-xl border border-purple-700/20 overflow-hidden flex flex-col w-full"
        >
          {/* Header */}
          ...
          <div className="flex-1 p-4 space-y-4 overflow-y-auto">
            {todayMatches.map((match, index) => (
              ...
              >
                ...
                <button className="w-full bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 text-xs py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-1">
          ...
          <div className="p-4 border-t border-purple-700/20">
            <button className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-sm py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center gap-2">
